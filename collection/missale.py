...
class Missale(Card):
        ...
        self._template = """
            ...
            <div class="item{% if oldNews %} oldNews{% endif %}">
                <div class="card lectionary">
                    <a target="_blank" href="{{data['url']}}" onclick="document.cookie='missale={{data['id']}}; expires=Fri, 31 Dec 9999 23:59:59 GMT;'">
    ...
    def harvestSync(self):
        # load from web
        site = "https://www.missale.net/of/nl"
        xpath = "//article"
