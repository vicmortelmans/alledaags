...
class Orthodox(Card):
            ...
            <div class="item{% if oldNews %} oldNews{% endif %}">
                <div class="card contemplation">
                    ...
                    <div class="actions">
                        ...
                        {% set title = my_encode("Orthodoxe Informatiebron: " + data['title'] + ' via alledaags.gelovenleren.net') %}
                        {% set short_title = my_encode("Orthodoxe Informatiebron: " + data['title']) %}
    ...
    def harvestSync(self):
        # load from feed
        feed = "https://orthodoxeinformatiebron.wordpress.com/feed/"
        harvest = getRSS(feed)
        data = {
            'name': "Orthodoxe Informatiebron",
            'image': "/static/iconen.jpg",
            'key': self._key
        }
        try:
            item = harvest['item'][0]
