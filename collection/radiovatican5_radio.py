...
class RadioVatican5Radio(Radio):
    def __init__(self):
        self._key = "radiovatican5-radio"
                        ...
                        $(function(){
                            ...
                            audio.addEventListener('loadedmetadata',function(){
                                ...
                                setInterval(function update() {
                                    var url = "https://en.radiovaticana.va/api/epgweb/transmissionapi/onair?idChannel=171&codeLanguage=en";
                                    var xpath = "/"
