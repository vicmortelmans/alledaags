...
class Eerherstel(Card):
    def __init__(self):
        self._key = "eerherstel"
    ...
    def harvestSync(self):
        # load from feed
        feed = "https://eerherstelheiligsacrament.org/feed/"
        harvest = getRSS(feed)
        data = {
            'name': "Eerherstel aan het Heilig Sacrament",
            'key': self._key
        }
        try:
            item = harvest['item'][0]
